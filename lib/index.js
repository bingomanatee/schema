(function (global, factory) {
  ...
  class FieldDef {
    constructor(name, params = {}) {
      if (is_1.string(params) || is_1.function(params) || is_1.array(params)) {
  ...
  class Schema {
    ...
    instance(config = {}) {
      const fields = lodash_get(config, 'fields', this.fields.keys());
      const record = lodash_get(config, 'values', {});
